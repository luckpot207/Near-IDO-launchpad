...
export default function Create() {
  ...
  const inTokenContract = new FtContract(
    initFtContract(
      inTokenId === 1 ? config.usdtContractId : config.usdcContractId
    )
  );
  ...
  const handleRegisterProject = async () => {
    ...
    const res = await registerProject({
      ...
      outTokenContract: new FtContract(initFtContract(outTokenId)),
      title,
      subTitle,
      logo,
      startingPrice,
  ...
  const getUserBalance = async () => {
    setUserBalance(
      await inTokenContract.getFtBalanceOfOwnerFormatted(accountIdNear)
    );
  };
            ...
            >
              ...
              >
                <Text
                  ...
                  marginBottom={4}
                >
                  You are about to pay 500 {Payment[inTokenId]} to Pegasus for
                  project registration and listing fee. Kindly click pay to
                  deduct 500 {Payment[inTokenId]} from your wallet
                </Text>
                <Text
                  as="h2"
                  fontSize="64px"
                  ...
                  <Flex alignItems={"center"}>
                    ...
                    <Flex>
                      <Menu>
                        ...
                        <MenuList>
                          <MenuOptionGroup
                            defaultValue={inTokenId.toString()}
                            title="Select assets"
                            type="radio"
          ...
          <Flex justifyContent="space-between">
            <Flex flexDirection="column" width="65%">
              ...
              <InputCard
                ...
                placeholder="https://t.me/cryptonear"
                required={true}
                setData={setTelegram}
                value={telegram}
            ...
            <Flex flexDirection="column" width="30%">
              <Flex marginBottom="2" justifyContent="flex-end">
                <Text as="h1" fontSize="20px" fontWeight="700" textAlign="end">
                  PROJECT PARTICULARS
                </Text>
              </Flex>
              <Flex>
