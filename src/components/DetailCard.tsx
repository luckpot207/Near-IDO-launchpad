...
import { Box, Flex, Text, Image, VStack, HStack, Progress, Button, Icon, Spacer, Input, Hide, Show } from '@chakra-ui/react';
        ...
        >
          ...
          <Show above='md'>
            <HStack
              ...
              margin='36px'
              justifyContent='center'
              spacing={{ base: '5px', md: '20px', lg: '40px' }}
            >
                ...
                <Show above='md'>
                  ...
                  >
                    ...
                    <Flex
                      ...
                      justifyContent='center'
                    >
                      <Button width='80%' colorScheme={'green'} onClick={() => { setDepositOpen(true) }} disabled={!activated}>DEPOSIT</Button>
                    </Flex>
                    <Flex
                      minWidth='100%'
                      minHeight='14'
                      justifyContent='center'
                    >
                      <Button width='80%' colorScheme={'blue'} onClick={() => { setDepositOpen(true) }} disabled={!activated}>WITHDRAW</Button>
                    </Flex>
                  </VStack>
                </Show>
              )}
