  ...
  return (
    <Flex marginY={4} flexDirection={'column'}>
      <Flex flexDirection={'column'}>
        ...
        <Text as='h1' fontSize='14px' lineHeight={'18px'} textAlign='justify' fontWeight='bold' marginY={2} color={'red.400'}>
      ...
      <Flex flexDirection={'column'}>
        ...
        <Text as='h1' fontSize='14px' lineHeight={'18px'} textAlign='justify' fontWeight='bold' marginY={2} color={color.border}>
